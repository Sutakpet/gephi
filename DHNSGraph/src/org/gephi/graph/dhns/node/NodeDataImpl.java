...
public class NodeDataImpl implements NodeData, GroupData {
    ...
    public String getLeftLabel() {
        ...
        return (String) attributes.getValue(PropertiesColumn.NODE_LEFT_LABEL.getIndex());
    }
    ...
    public String getRightLabel() {
        ...
        return (String) attributes.getValue(PropertiesColumn.NODE_RIGHT_LABEL.getIndex());
    }
}
