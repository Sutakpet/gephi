        ...
        public boolean evaluate(Graph graph, Node node) {
            if (nodeColumn != null) {
                ...
                if (obj != null) {
                    ...
                    if (timelineController.getModel().getPlayMode().equals(TimelineModel.PlayMode.ONE_BOUND)) {//prepinani mezi jednotlivymi filtry
                        return timeInterval.isInRange(visibleInterval.getLow(), visibleInterval.getHigh());
                    } else {
                        return timeInterval.isInIntervalRange(visibleInterval.getLow(), visibleInterval.getHigh());
                    }
                }
                return keepNull;
            }
